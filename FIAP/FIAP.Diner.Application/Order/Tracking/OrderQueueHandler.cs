...
namespace FIAP.Diner.Application.Order.Tracking
{
    public class OrderQueueHandler : IQueryHandler<GetOrderQueueQuery, IEnumerable<OrderDetails>>
    {
        ...
        public OrderQueueHandler(IOrderRepository orderRepository) => _orderRepository = orderRepository;

        public async Task<IEnumerable<OrderDetails>> Handle(GetOrderQueueQuery query, CancellationToken cancellation)
